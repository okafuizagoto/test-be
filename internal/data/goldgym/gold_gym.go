...
const (
	...
	uploadTestingImages  = "UploadTestingImages"
	qUploadTestingImages = `INSERT INTO image_test (id, content) VALUES (?, ?)`

	getTestingImage  = "GetTestingImage"
	qGetTestingImage = `SELECT content FROM image_test WHERE id = ?`
)
...
var (
	readStmt = []statement{
		...
		{getTestingImage, qGetTestingImage},
	}
	insertStmt = []statement{
		...
		{uploadTestingImages, qUploadTestingImages},
	}
